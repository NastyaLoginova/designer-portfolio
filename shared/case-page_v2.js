...
function createCaseLeadV2(title, subtitle, logo) {
...
function createCaseBlockV2(block) {
  const container = createElement('div', { className: 'case-block-v2' });
...
function createCaseContentV2(blocks = [], options = {}) {
  ...
  const lead = createCaseLeadV2(options.title, options.subtitle, options.logo);
